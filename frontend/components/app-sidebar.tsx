...
import {
  LayoutDashboard, Users, Building2, Shield, ScrollText, Bell,
  UserCircle, LogOut, ChevronUp, Home, KeyRound, ShoppingCart, Key,
} from 'lucide-react';
import {
          ...
          <SidebarMenuItem>
            <SidebarMenuButton render={<Link href="/dashboard" />} size="lg">
              ...
              <div className="flex flex-col gap-0.5 leading-none">
                ...
                <span className="text-xs text-muted-foreground">Quản lý API Key</span>
              </div>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
